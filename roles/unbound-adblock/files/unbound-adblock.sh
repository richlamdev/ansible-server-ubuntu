...
# the non-POSIX 'typeset' feature and bash array syntax.
# ---
# By default unbound-adblock looks for 'bash' in the users $PATH
# unbound-adblock also supports the following shells:
#     pdbash (and variants), bash93, mbash, bash, or zsh
#
...
# NOTE: DO NOT put quotes in here, as there is a bug in most pdbash
